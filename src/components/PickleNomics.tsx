export default function PickleNomics() {
  return (
    ...
    >
      <img src={"/parachot.png"} className="w-[298px] absolute left-28 top-8" />
      <img
        src="/first-futility-token.png"
        className="w-[392px] absolute right-16 top-8"
      />
      ...
      <div className="flex flex-col justify-start gap-12 items-center w-min">
        <div className="flex flex-col justify-start items-center flex-grow relative gap-3">
          <p className="m-0 text-[150px] px-12 font-bold text-left text-black">
            Picklenomics
          </p>
        </div>
      ...
      <div className="flex flex-col items-center gap-6 justify-center">
        <div className="flex items-center justify-center relative px-20">
          <p className="text-[100px]  leading-[128px] m-0 pt-14 font-bold text-center z-10 text-[#dffe71]">
            0% tax, no harm to your pockets
          </p>
          <img
            src={"/no-harm.png"}
            className="absolute top-0 left-0 right-0 bottom-0 w-full z-0"
          />
        </div>

        <div className="flex items-center justify-center relative px-20">
          <img
            src={"/420-trillion.png"}
            className="absolute top-0 left-0 right-0 bottom-0 w-full z-0"
          />
          <p className="text-[100px]  leading-[100px] m-0 pt-14 font-bold text-center z-10 text-[#dffe71]">
            420 Trillion Tokens
          </p>
        </div>
      </div>
