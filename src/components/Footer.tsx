  ...
  return (
    <div className="flex px-6 py-11 md:px-[144px]  flex-col justify-center items-center gap-2.5 p-2.5 bg-[#101010]">
      <p className="m-0 text-[30px] text-left text-[#efffb5]  px-3 md:p-20">
        ...
        guarantee any financial returns. It is crucial to conduct thorough
        research and exercise caution while trading cryptocurrencies. Remember,
        the crypto market can be volatile, so it’s essential to stay informed
        and make informed decisions. Always do your research and approach crypto
        trading with care.
      </p>
    </div>
  );
